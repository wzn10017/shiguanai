...
parser.add_argument('--train_lib', type=str, default=r'../output/lib/rnn_train_data_lib.db', help='path to train MIL library binary')
parser.add_argument('--val_lib', type=str, default=r'../output/lib/rnn_val_data_lib.db', help='path to validation MIL library binary. If present.')
...
parser.add_argument('--s', default=10, type=int, help='how many top k tiles to consider (default: 10)')
parser.add_argument('--ndims', default=128, type=int, help='length of hidden representation (default: 128)')
parser.add_argument('--model', default=r'../output/CNN_checkpoint_best.pth', type=str, help='path to trained model checkpoint')
parser.add_argument('--weights', default=0.5, type=float, help='unbalanced positive class weight (default: 0.5, balanced classes)')
