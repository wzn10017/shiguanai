...
'''
parser.add_argument('--lib', type=str, default=r'../output/lib/rnn_test_data_lib.db', help='path to train MIL library binary')
...
parser.add_argument('--rnn', default=r'../output/rnn_checkpoint_best.pth', type=str, help='path to trained RNN model checkpoint')
