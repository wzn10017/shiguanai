...
parser.add_argument('--lib', type=str, default=r'../output/lib/cnn_test_data_lib.db', help='path to data file')
parser.add_argument('--output', type=str, default=r'../output/', help='name of output directory')
parser.add_argument('--model', type=str, default=r'../output/CNN_checkpoint_best.pth', help='path to pretrained model')
parser.add_argument('--batch_size', type=int, default=2048, help='how many images to sample per slide (default: 2048)')
